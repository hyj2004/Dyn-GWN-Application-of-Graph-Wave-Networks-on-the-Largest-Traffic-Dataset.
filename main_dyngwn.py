...
#     parser.add_argument('--device', type=str, default='cuda', help='')
    parser.add_argument('--data', type=str, default='/home/dsj22/LargeST-main/dyngwn_meta-la/DynGWN/GLA/GLA_train_val_test2019', help='data path')
    parser.add_argument('--adjdata', type=str,default='/home/dsj22/LargeST-main/dyngwn_meta-la/DynGWN/GLA/gla_adj.pkl', help='adj data path')
    ...
    parser.add_argument('--dynamic_gcn_bool',default=True, help='whether to add dynamic graph convolution layer')
    parser.add_argument('--dynamic_supports_len', type=int, default=1, help='num_features')
    parser.add_argument('--dynamic_graph', type=str, default='partial-correlation', help='which graph method to use')
    ...
    parser.add_argument('--epochs', type=int, default=65, help='')
    parser.add_argument('--print_every', type=int, default=50, help='')
    #parser.add_argument('--seed',type=int,default=99,help='random seed')
    parser.add_argument('--save_directory', type=str, default='/home/dsj22/LargeST-main/dyngwn_meta-la/DynGWN/GLA/gla_trainmodel2019', help='save path')
